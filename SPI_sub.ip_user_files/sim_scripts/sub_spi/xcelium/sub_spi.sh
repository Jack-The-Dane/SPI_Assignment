...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sub_spi xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sub_spi -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jacob/Documents/Semester4/FPGA/Assignment_3/SPI_sub/SPI_sub.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sub_spi_sc.so .tmp_log xcelium_lib waves.shm c.obj)
