...
#
# Script generated by Vivado on Wed May 15 15:42:29 CEST 2024
...
#
# Usage        : sub_spi.sh
#                sub_spi.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sub_spi.sh [-reset_run]
#                sub_spi.sh [-reset_log]
#                sub_spi.sh [-help]
#
...
# script info
echo -e "sub_spi.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sub_spi.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sub_spi xil_defaultlib.sub_spi xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sub_spi -key {Behavioral:sim_1:Functional:sub_spi} -tclbatch cmd.tcl -protoinst "protoinst_files/sub_spi.protoinst" -protoinst "protoinst_files/uart_loop.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jacob/Xilinx/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sub_spi.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sub_spi.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sub_spi.sh [-help]\n\
Usage: sub_spi.sh [-step]\n\
Usage: sub_spi.sh [-lib_map_path]\n\
Usage: sub_spi.sh [-reset_run]\n\
Usage: sub_spi.sh [-reset_log]\n\
Usage: sub_spi.sh [-keep_index]\n\
Usage: sub_spi.sh [-noclean_files]\n\n\
