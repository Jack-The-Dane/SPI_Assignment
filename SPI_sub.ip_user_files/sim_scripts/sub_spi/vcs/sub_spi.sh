...
#                script (type 'sub_spi.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sub_spi xil_defaultlib.glbl -o sub_spi_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sub_spi_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jacob/Documents/Semester4/FPGA/Assignment_3/SPI_sub/SPI_sub.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key sub_spi_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sub_spi_simv.daidir vcs_lib c.obj)
