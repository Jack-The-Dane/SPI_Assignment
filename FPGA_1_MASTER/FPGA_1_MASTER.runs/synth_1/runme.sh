...
HD_PWD='C:/Users/Corne/Documents/MEGA/4. Semester/Digital/SPI_Assignment/FPGA_1_MASTER/FPGA_1_MASTER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Master_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Master_wrapper.tcl
