...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fsm_template is
  ...
  signal one_shot2_i_1_n_0 : STD_LOGIC;
  signal one_shot2_reg_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of one_shot2_i_1 : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \shift_reg[10]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \shift_reg[11]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \shift_reg[12]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \shift_reg[13]_i_1\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \shift_reg[16]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \shift_reg[17]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \shift_reg[18]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \shift_reg[19]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \shift_reg[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \shift_reg[4]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \shift_reg[5]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \shift_reg[6]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \shift_reg[7]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \shift_reg[8]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \shift_reg[9]_i_1\ : label is "soft_lutpair6";
begin
...
one_shot2_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BF01"
    )
        port map (
      ...
      I1 => current_state(1),
      I2 => current_state(0),
      I3 => one_shot2_reg_n_0,
      O => one_shot2_i_1_n_0
    );
one_shot2_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
