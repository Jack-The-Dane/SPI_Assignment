...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fsm_template is
  ...
  signal transmission_done_reg_i_1_n_0 : STD_LOGIC;
  signal transmission_done_reg_i_2_n_0 : STD_LOGIC;
  ...
  attribute XILINX_LEGACY_PRIM of transmission_done_reg : label is "LD";
  attribute XILINX_TRANSFORM_PINMAP of transmission_done_reg : label is "VCC:GE GND:CLR";
  attribute SOFT_HLUTNM of transmission_done_reg_i_2 : label is "soft_lutpair0";
begin
...
MISO_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
...
transmission_done_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
transmission_done_reg_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
transmission_done_reg_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
