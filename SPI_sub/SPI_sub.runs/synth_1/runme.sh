...
HD_PWD='C:/Users/Corne/Documents/MEGA/4. Semester/Digital/SPI_Assignment/SPI_sub/SPI_sub.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log assignment_3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source assignment_3_wrapper.tcl
