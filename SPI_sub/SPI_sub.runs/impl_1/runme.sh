...
HD_PWD='C:/Users/Corne/Documents/MEGA/4. Semester/Digital/SPI_Assignment/SPI_sub/SPI_sub.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log assignment_3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source assignment_3_wrapper.tcl -notrace
